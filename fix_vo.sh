cat << 'INNEREOF' > patch_vo.diff
--- src/Domain/TontineManagement/ValueObjects/ContributionAmount.cs
+++ src/Domain/TontineManagement/ValueObjects/ContributionAmount.cs
@@ -2,18 +2,21 @@
...
--- src/Domain/TontineManagement/ValueObjects/Reglement.cs
+++ src/Domain/TontineManagement/ValueObjects/Reglement.cs
@@ -2,18 +2,21 @@
